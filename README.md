...
| --- | --- | --- |
| **Owned template artifacts** | `tools/shared-browser/*`, `tools/worktree-domains/*`, `HOUSE.md`, `post-create.sh`, a devcontainer the generator owns | **Regenerated every sync** |
