...
| `.claude/settings.json` declares the `claude-toolkit` marketplace with `"autoUpdate": true` and enables `project-starter@claude-toolkit` + `engineering@claude-toolkit` + `browser-automation@claude-toolkit` | `<project>/.claude/settings.json` | `--repair` |
