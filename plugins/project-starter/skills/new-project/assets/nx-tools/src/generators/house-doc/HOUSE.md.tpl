...
<!-- @bespunky/house-tooling:stamp nx-tools={{NX_TOOLS_VERSION}} plugin={{PLUGIN_VERSION}} -->
...
- **Design system**: `packages/design-system` — the single source of visual truth (see below).
