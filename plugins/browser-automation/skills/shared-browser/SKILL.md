...
| **Scripted / automated / CI** check — no human watching, headless is fine, you want a repeatable file artifact | **`bespunky-browser-automation:playwright`** (headless script) |
