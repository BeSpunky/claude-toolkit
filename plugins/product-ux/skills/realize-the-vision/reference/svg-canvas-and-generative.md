...
- **A glow needs a present hot core, not just a halo.** A continuous falloff can over-soften into all-aura-no-centre. Real incandescence has a small, *bright, concentrated* core (often clipping toward white-hot) with the soft bloom around it — keep the core's presence; don't let the smooth curve wash it away.
